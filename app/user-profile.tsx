  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        >
          {isEditing ? (
            <Save size={24} color="#6B8E23" />
          ) : (
            <Edit2 size={24} color="#6B8E23" />
          )}
        </TouchableOpacity>
      </View>
